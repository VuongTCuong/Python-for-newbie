...
<?php
    ...
    $stm='select sanpham.hinhSP, sanpham.tenSP, giohang.soluong , giohang.tongGia
          from giohang 
          inner join sanpham
          where giohang.tennguoidung="' . $name .'" and sanpham.tenSP=giohang.tenSP group by sanpham.tenSP' ;
...
<body>
    ...
    <section class="cart">
            ...
            <div class="cart-content row">
                    ...
                    <table>
                        ...
                        <?php
                            while($row=mysqli_fetch_assoc($result)){
                                ...
                                echo '<td><form method="post" action="delete_cart_action.php">
                ...
                <div class="cart-content-right">
                    <table>
                        ...
                        <?php
                            if($nums>=1) echo '<tr><td>Products:</td><td></td></tr>';     
                            $result=mysqli_query($conn,$stm);
                            while($row=mysqli_fetch_assoc($result)){        
                                echo '<tr>';
                                echo '<td></td>';
                        ...
                        <tr>
                            ...
                            <?php
                                if($nums>=1) echo '<td>Total Price: </td>';
                                $sum=0;
                                $result=mysqli_query($conn,$stm);
                                while($row=mysqli_fetch_assoc($result)){        
                                    $sum+=$row['tongGia'];
                                }
                                if($nums>=1) echo '<td><p>'.$sum.' vnđ</p></td>';
                            ?>
                    ...
                    <div class="cart-content-right-button">
                        <?php
                            if($nums>=1) {
                                ...
                                echo '<a href="delivery.php"><button>PROCEED TO PAYMENT</button></a>';
                            }
                        ?>
                    </div>
        ...
        <div class="donhang_center">
            <br><br>
            <a href="donhang.php"><p>Xem đơn hàng</p></a>
        </div>
    </section>
